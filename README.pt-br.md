...
## 🌌 Sobre mim
Gosto de ler artigos sobre **astronomia**, **tecnologia** e **música**.  
No meu tempo livre, costumo jogar e explorar novas tecnologias. 🚀
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=fariasxyz&layout=compact&theme=tokyonight&langs_count=8" alt="Linguagens Mais Usadas"/>
</p>
...
| Projeto | Descrição |
|---|---|
| [C# Exercises](https://github.com/fariass07/csharp) | Coleção de exercícios em C# cobrindo POO, estruturas de dados e algoritmos |
| [SerpAPI](https://github.com/fariass07/serpAPI) | Wrapper de API para extração e processamento de resultados de busca |
| [Banco Virtual (C#)](https://github.com/fariass07/BANCO-VIRTUAL-C-) | Simulação de sistema bancário com gerenciamento de contas e transações |
| [Bot Discord (JavaScript)](https://github.com/fariass07/BOT-DISCORD) | Bot para Discord com comandos de moderação e utilitários |
| [E-Commerce: Miquella's Store (C#)](https://github.com/fariass07/Miquellas-Store) | Plataforma de e-commerce com listagem de produtos e carrinho de compras |
